...
dishes.lan_m_chips = {
    ...
    potlevel = "high", -- 动画在烹饪锅的位置高低,建议一个mod中所有料理固定一个值
    ...
    cookbook_tex = "lan_m_chips", -- 烹饪指南中显示的图片名,不写则用prefab名
    cookbook_atlas = "images/inventoryimages/lan_m_chips.xml", -- 烹饪指南中显示的图片图集,不写则用inventoryimages
